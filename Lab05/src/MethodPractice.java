...
public class MethodPractice {
	public static void main(String[] args) {
		...
		a = myScan.nextInt();
		b = myScan.nextInt();
		System.out.println("The max of " + a + " and  " + b + " is: "
				+ max(a, b));
		...
		if (radius > 0) {
			System.out.println("The area of a sphere with this radius is: "
					+ sphereArea(radius));
		} else {
			System.out
					.println("The area of a sphere with this radius is: 0.00");
		}
